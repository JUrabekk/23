#И снова время рисовать! Новый год прошел достаточно давно, поэтому хочется опять
#вернуть новогоднее настроение. Давайте с использованием библиотеки PIL нарисуем
#ёлочку.
#Напишите функцию picture(file_name, width, height, sky_color, snow_color, trunk_color,
#needls_color, sun_color):
